  ...
  return (
    ...
    <title >Instagram</title>
      ...
      <div className="grid gap-4">
        ...
        <div className="grid gap-2">
          <Input value={fullName} onChange={(e) => setfullName(e.target.value)} id="text" type="text" required  placeholder="Fullname"/>
        </div>
        <div className="grid gap-2">
          <Input value={email} onChange={(e) => setemail(e.target.value)} id="email" type="email" required  placeholder="email"/>
        </div>
        <div className="grid gap-2">
